          ...
          <i class="hamburger align-self-center"></i>
                ...
                <i class="align-middle" data-feather="settings"></i>
							...
							<a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
								<?php $avatar = isset($_SESSION["nguoidung"]) && !empty($_SESSION["nguoidung"]["hinhanh"]) ? "../../images/users/" . $_SESSION["nguoidung"]["hinhanh"] : "../../images/users/user.png"; ?>
								<img src="<?php echo $avatar; ?>" class="avatar img-fluid rounded me-1" /> 
								<span class="text-dark">Chào <?php echo isset($_SESSION["nguoidung"]) ? ($_SESSION["nguoidung"]["hoten"] ?? "bạn") : "bạn"; ?></span>
							</a>
