            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <div class="d-flex align-items-center">
                        <?php 
                        // Kiểm tra nếu người dùng đã đăng nhập thì hiển thị tên và nút Đăng xuất
                        if(isset($_SESSION["nguoidung"])){ 
                        ?>
                            <span class="text-white me-3">Chào <?php echo $_SESSION["nguoidung"]["hoten"]; ?></span>
                            <!-- Link trỏ về action đăng xuất của trang Admin -->
                            <a href="../admin/ktnguoidung/index.php?action=dangxuat" class="text-white text-decoration-none me-3">Đăng xuất</a>
                        <?php } else { ?>
                            <!-- Nếu chưa đăng nhập thì hiển thị nút Đăng nhập -->
                            <a href="../admin/ktnguoidung/index.php" class="btn btn-outline-light me-2"><i class="bi bi-person"></i> Đăng nhập</a>
                        <?php } ?>
                        
                        <!-- Nút Giỏ hàng gọi hàm đếm số lượng động -->
