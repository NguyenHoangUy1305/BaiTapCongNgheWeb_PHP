    ...
    <div class="col-md-9 border-end pe-4">
        <div class="row">
            ...
            <div class="col-md-6 pt-3">
                ...
                <p class="text-secondary"><i class="bi bi-eye"></i> Lượt xem: <?php echo $mhct['luotxem']; ?></p>
                ...
                <div class="col-12 mb-4">
                    <div class="card text-center shadow-sm border-0 h-100">
                        <a href="?action=detail&id=<?php echo $m['id']; ?>">
                            <img src="../<?php echo $m['hinhanh']; ?>" class="card-img-top p-2" alt="<?php echo $m['tenmathang']; ?>" style="height: 120px;">
                        </a>
