    ...
    <div class="wrapper">
        <nav id="sidebar" class="sidebar js-sidebar">
            <div class="sidebar-content js-simplebar">
                <a class="sidebar-brand" href="../ktnguoidung/index.php">
                    <span class="align-middle">ABC Shop</span>
                </a>
                <ul class="sidebar-nav">
                    <li class="sidebar-header text-info">HỆ THỐNG</li>
                    <li class="sidebar-item <?php if(strpos($_SERVER['REQUEST_URI'], "ktnguoidung") !== false && !isset($_REQUEST['action'])) echo "active"; ?>">
                    ...
                    <!-- Kiểm tra chỉ Quản trị viên mới thấy Quản lý người dùng -->
                    ...
                    <li class="sidebar-header text-info">DANH MỤC</li>
                    ...
                    <li class="sidebar-header text-info">KINH DOANH</li>
                    <li class="sidebar-item"><a class="sidebar-link" href="#"><i class="align-middle" data-feather="users"></i> <span class="align-middle">Quản lý khách hàng</span></a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="#"><i class="align-middle" data-feather="truck"></i> <span class="align-middle">Quản lý đơn hàng</span></a></li>
                    <li class="sidebar-item"><a class="sidebar-link" href="#"><i class="align-middle" data-feather="bar-chart-2"></i> <span class="align-middle">Quản lý doanh thu</span></a></li>
                </ul>
            </div>
        </nav>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
                                <?php 
                                    ...
                                    if(isset($_SESSION["nguoidung"]) && $_SESSION["nguoidung"]["hinhanh"] != NULL) {
                                        $avt = "../../images/users/" . $_SESSION["nguoidung"]["hinhanh"];
                                    } else {
                                        $avt = "../../images/users/user.png";
                                    }
                                ?>
                                <img src="<?php echo $avt; ?>" class="avatar img-fluid rounded me-1" alt="User" /> 
